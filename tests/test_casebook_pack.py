"""Regression checks for the keystone-algo-graph-flow casebook."""
...
from casebook.harness import assert_expected, keystone_algo_graph_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(keystone_algo_graph_flow_summary(), assert_expected())
